...
service ClientVoiceToText {
	...
	bool onChannelCreated( 1:i32 server_id, 2:i32 invokerClientID, 3:i32 channelID, 4:string clientNick )		
	bool onChannelEdited( 1:i32 server_id, 2:i32 invokerClientID, 3:i32 channelID, 4:string clientNick )		
	bool onChannelDeleted( 1:i32 server_id, 2:i32 invokerClientID, 3:i32 channelID, 4:string clientNick )
