...
DISCONNECT (5), // { op:5 }
CHAT_WITH (6), // { op:6, profilo_id:int, message:"String" }
CHAT_OPEN (7), // { op:7, profilo_id:int, nickname:"String" }
CHAT_CLOSE (8), //  { op:8, profilo_id:int }
LIST (9); // { op:9, list:[{profilo_id:int, nickname:String},{profilo_id:int, nickname:String},{profilo_id:int, nickname:String}] }
